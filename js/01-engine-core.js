...
const DEFAULT_SAVE = {
  ...
  settings: { master: .8, music: .55, sfx: .9, shake: 1, grain: 1, bloom: 1, boot: 1, theme: "dark",
    autofire: 0, aimassist: 0, brightness: .5 },
};
...
const CH09_LEVELS = [
  { name: "The Shallows", hook: "Shallow water. Two kinds of trouble, and both of them come straight at you.",
    waves: 4, types: ["husk", "dart"], intro: ["husk", "dart"], env: "motes",
  ...
  { name: "Iron Garden", hook: "Heavier things grow here. The plated ones are only armoured at the front.",
    waves: 4, types: ["husk", "colossus", "bulwark", "howitzer"], intro: ["colossus", "bulwark", "howitzer"], env: "pillars",
  ...
  { name: "Spore Field", hook: "Everything in this room divides when it dies. Give it room, or don't kill it yet.",
    waves: 4, types: ["husk", "bloom", "spore", "broodmother"], intro: ["bloom", "spore", "broodmother"], env: "spores",
  ...
  { name: "The Long Range", hook: "They stopped walking to you. Now they reach, and standing still is the mistake.",
    waves: 4, types: ["dart", "weaver", "needle", "hexer"], intro: ["weaver", "needle", "hexer"], env: "rain",
  ...
  { name: "Mirror Line", hook: "Something here has been watching how you move. It has been taking notes.",
    waves: 4, types: ["husk", "bulwark", "mimic", "mirror", "revenant"], intro: ["mimic", "mirror", "revenant"], env: "mirror",
  ...
  { name: "The Fold", hook: "All of it at once, and then the thing that has been folding the room around you.",
    waves: 3, boss: true, types: ["husk", "dart", "bloom", "weaver", "mimic", "warden", "revenant"], intro: ["warden", "paradox"], env: "fold",
...
Object.assign(EN, {
  ...
  facet: { hp: 44, sp: 78, r: 13, dmg: 16, cost: 2, score: 22, shards: 1, col: "168,232,255",
    label: "Facet", note: "A cut-glass tetrahedron. It drifts, catches your light, and refracts it back as three thin rays." },
  prism: { hp: 118, sp: 52, r: 17, dmg: 22, cost: 4, score: 46, shards: 3, col: "214,246,255",
  ...
  rime: { hp: 46, sp: 138, r: 12, dmg: 18, cost: 2, score: 24, shards: 1, col: "150,214,255",
    label: "Rime", note: "Fast, and it lays cold behind it. The trail doesn't hurt — it just makes you slow enough for everything else." },
  silica: { hp: 176, sp: 40, r: 21, dmg: 26, cost: 5, score: 64, shards: 4, col: "196,226,248",
  ...
  kelvin: { hp: 132, sp: 34, r: 17, dmg: 0, cost: 4, score: 70, shards: 4, col: "120,236,240",
    label: "Kelvin", note: "Drops a ring of absolute cold and closes it. The ring is the damage — the middle is safe until it isn't." },
  stillhour: { hp: 2600, sp: 44, r: 44, dmg: 36, cost: 0, score: 1200, shards: 60, col: "186,238,255",
  ...
  filament: { hp: 40, sp: 92, r: 12, dmg: 20, cost: 2, score: 24, shards: 1, col: "255,206,120",
    label: "Filament", note: "Arrives in pairs and strings a burning wire between the two. Kill either one and the wire goes out." },
  corona: { hp: 126, sp: 46, r: 18, dmg: 24, cost: 4, score: 52, shards: 3, col: "255,166,72",
  ...
  vestige: { hp: 60, sp: 88, r: 13, dmg: 18, cost: 2, score: 28, shards: 2, col: "196,196,204",
  ...
  coda: { hp: 78, sp: 60, r: 15, dmg: 24, cost: 3, score: 40, shards: 2, col: "232,206,150",
